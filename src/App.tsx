...
function App() {
  ...
  const handleCategoryFilter = (category: string) => {
    ...
    let categoryAffirmations;
    
    switch (category) {
      case 'love':
        categoryAffirmations = allAffirmations.filter(a => a.category === 'love');
        break;
      case 'wealth':
        categoryAffirmations = allAffirmations.filter(a => a.category === 'wealth');
        break;
      case 'health':
        categoryAffirmations = allAffirmations.filter(a => a.category === 'health');
        break;
      case 'learning':
        categoryAffirmations = allAffirmations.filter(a => a.category === 'learning');
        break;
      case 'natural':
        categoryAffirmations = allAffirmations.filter(affirmation =>
          ['natural', 'state', 'form', 'cell', 'being'].some(keyword =>
            affirmation.text.toLowerCase().includes(keyword.toLowerCase())
          )
        );
        break;
      default:
        categoryAffirmations = allAffirmations;
    }
    ...
    // Close popup and return to main view
